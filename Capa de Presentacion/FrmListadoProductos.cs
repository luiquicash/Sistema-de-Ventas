...

    {
        ...
        public void CargarListado(string palabra = null)
        {
            try
            {
                ...
                if (palabra != null)
                {
                    ...
                    comando.CommandText = "Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis," +
        ...
        private void rbCero_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rbCero.Checked == true)
            {
                ...
                comando.Connection = con;
                //declaramos el comando para realizar la busqueda
                comando.CommandText = "	Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis,Pmax =COALESCE(dbo.Producto.Pmax,0),Pmin =COALESCE(dbo.Producto.Pmin,0) From Producto Where Stock=0 ORDEN BY IdProducto";
                //especificamos que es de tipo Text
                comando.CommandType = CommandType.Text;
                //se abre la conexion
                con.Open();
        ...
        private void rdmedia_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rdmedia.Checked == true)
            {
                ...
                comando.Connection = con;
                //declaramos el comando para realizar la busqueda
                comando.CommandText = "Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis,Pmax =COALESCE(dbo.Producto.Pmax,0),Pmin =COALESCE(dbo.Producto.Pmin,0) From Producto Where Stock >4  And Stock <11 ORDEN BY IdProducto";
                //especificamos que es de tipo Text
                comando.CommandType = CommandType.Text;
                //se abre la conexion
                con.Open();
        ...
        private void rbbuena_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rbbuena.Checked == true)
            {
                ...
                comando.Connection = con;
                //declaramos el comando para realizar la busqueda
                comando.CommandText = "Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis,Pmax =COALESCE(dbo.Producto.Pmax,0),Pmin =COALESCE(dbo.Producto.Pmin,0) From Producto Where Stock >10 ORDEN BY IdProducto";
                //especificamos que es de tipo Text
                comando.CommandType = CommandType.Text;
                //se abre la conexion
                con.Open();
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked == true)
            {
                ...
                comando.Connection = con;
                //declaramos el comando para realizar la busqueda
                comando.CommandText = "Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis,Pmax =COALESCE(dbo.Producto.Pmax,0),Pmin =COALESCE(dbo.Producto.Pmin,0) From Producto Where Stock >0 and Stock <5 ORDEN BY IdProducto";
                //especificamos que es de tipo Text
                comando.CommandType = CommandType.Text;
                //se abre la conexion
                con.Open();
        ...
        private void cbxCategoria_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (id.Text != "")
            {
                ...
                comando.Connection = con;
                //declaramos el comando para realizar la busqueda
                comando.CommandText = "Select IdProducto,IdCategoria,Nombre,Marca,PrecioCompra,PrecioVenta,Stock,FechaVencimiento,FechaModificacion,itbis,Pmax =COALESCE(dbo.Producto.Pmax,0),Pmin =COALESCE(dbo.Producto.Pmin,0) From Producto Where IdCategoria=" + id.Text+ " ORDEN BY IdProducto";
                //especificamos que es de tipo Text
                comando.CommandType = CommandType.Text;
                //se abre la conexion
                con.Open();
